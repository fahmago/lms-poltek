...
// ✅ PERUBAHAN: Ganti props 'prodis' menjadi 'kategoriList'
export default function FilterControls2({ kategoriList, angkatans, onFilterChange, isLoading }) {
    ...
    }, [filters]); // 'filters' sebagai dependensi sudah benar
