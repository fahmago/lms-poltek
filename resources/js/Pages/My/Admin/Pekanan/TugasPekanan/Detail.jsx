...
import GradeSubmissionModal from './KomponenPekanan/GradeSubmissionModal';
import AnswerContent from './KomponenPekanan/AnswerContent';
import RecapStats from './KomponenPekanan/RecapStats';

export default function Detail() {
    const { tugasPekanan, rekapPerKelas, stats, errors, flash } = usePage().props;
    ...
    const getProdiSingkatan = (namaProdi) => {
        ...
        return mapping[namaProdi] || namaProdi; // fallback ke nama asli kalau belum didefinisikan
    };
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-white/70 backdrop-blur-xl rounded-2xl shadow-md p-6 border border-white/20 hover:shadow-xl transition-all duration-300">
                            ...
                            <div className="flex justify-between items-center border-b pb-3">
                                <Link
                                    href={route('my.tweek.show', tugasPekanan.prodi.uuid)}
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    <Link
                                        ...
                                        href={route('my.tweek.edit', tugasPekanan.uuid)}
                                        className="hover:no-underline text-sm text-blue-600 flex items-center gap-2 ml-1"
                                    >
                            ...
                            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-2 md:gap-4 py-3">
                                ...
                                >
                                    prodi {getProdiSingkatan(tugasPekanan.prodi.nama_prodi)}
                                </span>
                            </div>
                            ...
                            <div className="grid grid-cols-2 gap-4 border-b pb-4">
                                <div className="bg-blue-50 rounded-lg p-3 text-sm">
                                    ...
                                    <p className="text-gray-800 mt-1">
                                        {formatDate(tugasPekanan.waktu_mulai, { includeTime: true })}
                                    </p>
                                </div>
                                <div className="bg-red-50 rounded-lg p-3 text-sm">
                                    <p className="text-red-700 font-semibold">Batas Waktu</p>
                                    <p className="text-gray-800 mt-1">
                                        {formatDate(tugasPekanan.batas_waktu, { includeTime: true })}
                                    </p>
                                </div>
                            </div>
                                    ...
                                    <div className="flex-1 pr-4">
                                        ...
                                        <div className="flex justify-between items-center mb-2">
                                            ...
                                            <span className="text-xs text-gray-600 flex items-center gap-1 whitespace-nowrap">
                                                {/* <i className="fa fa-user-tie text-indigo-500"></i> */}
                                                {kelas.dosen_name}
                                            </span>
                                        </div>
