...
export default function Create() {
    ...
    // 'catatan' dihapus karena tidak ada di migrasi portofolio
    ...
    const handleSubmit = (e) => {
        ...
        // GANTI: route
        Inertia.post(route('my.portofolio.store'), dataToSend, {
    ...
    return (
        <MyLayout>
            {/* GANTI: title */}
            <Head title="Buat Portofolio" />
            <div className="mx-auto">
                <div className="bg-white shadow-md rounded-lg">
                    <div className="bg-blue-600 p-4 rounded-t-lg">
                        {/* GANTI: icon & teks */}
                        <span className="font-bold text-white tracking-widest"><i className="fa fa-id-card mr-2"></i>Buat Portofolio</span>
                    </div>
                    <form onSubmit={handleSubmit} className="p-8 space-y-8">
                        ...
                        <div className="flex justify-start pt-6 border-t">
                            <ButtonSave type="submit" disabled={isSubmitting}>
                                {/* GANTI: teks */}
                                {isSubmitting ? <><i className="fa fa-spinner fa-spin mr-2"></i> Menyimpan...</> : <><i className="fa fa-save mr-2"></i> Buat Portofolio</>}
                            </ButtonSave>
                        </div>
                    </form>
                </div>
