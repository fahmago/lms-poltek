...
import GradeSubmissionModal from '../../Pekanan/TugasPekanan/KomponenPekanan/GradeSubmissionModal'; // Re-use modal
import RecapStats from '../../Pekanan/TugasPekanan/KomponenPekanan/RecapStats'; // Re-use stats
import AnswerContent from './AnswerContent';

export default function Detail() {
    // GANTI: 'projectSemester' menjadi 'portofolio'
    const { portofolio, rekapPerKelas, stats, errors, flash } = usePage().props;
    ...
    const handleSubmitGrade = ({ nilai, feedback, submissionId }) => {
        ...
        Inertia.post(route('my.portofolio.submit_grade', { pengumpulanPortofolio: submissionId }), {
            nilai,
                        ...
                        <div className="bg-white/70 backdrop-blur-xl rounded-2xl shadow-md p-6 border border-white/20 hover:shadow-xl transition-all duration-300">
                            ...
                            <div className="flex justify-between items-center border-b pb-3">
                                <Link
                                    ...
                                    href={route('my.portofolio.show', portofolio.prodi.uuid)}
                                ...
                                <div className="flex gap-2">
                                    <Link
                                        // GANTI: route dan prop
                                        href={route('my.portofolio.edit', portofolio.uuid)}
                                        className="hover:no-underline text-sm text-blue-600 flex items-center gap-2"
                                    >
                            ...
                            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-2 md:gap-4 py-3">
                                ...
                                <span
                                    ...
                                    // GANTI: 'portofolio' -> 'portofolio'
                                    title={portofolio.prodi.nama_prodi}
                                >
                                    prodi {getProdiSingkatan(portofolio.prodi.nama_prodi)}
                                </span>
                            </div>
