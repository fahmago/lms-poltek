...
export default function Create() {
    ...
    const [catatan, setCatatan] = useState(''); // GANTI: dari tipeTugas ke catatan
    ...
    const handleSubmit = (e) => {
        ...
        // GANTI: route
        Inertia.post(route('my.project_semester.store'), dataToSend, {
    ...
    return (
        <MyLayout>
            {/* GANTI: title */}
            <Head title="Buat Project Semester" />
            <div className="mx-auto">
                <div className="bg-white shadow-md rounded-lg">
                    <div className="bg-blue-600 p-4 rounded-t-lg">
                        {/* GANTI: icon & teks */}
                        <span className="font-bold text-white tracking-widest"><i className="fa fa-clipboard-list mr-2"></i>Buat Project Semester</span>
                    </div>
                    <form onSubmit={handleSubmit} className="p-8 space-y-8">
                        ...
                        <div className="space-y-6 pt-6 border-t">
                            ...
                            {/* GANTI: Hapus grid, buat judul full width */}
                            <div className="grid grid-cols-1 gap-6">
                                ...
                                {/* HAPUS: SelectField2 untuk tipe_tugas dihapus */}
                            </div>
                            ...
                            <div>
                                ...
                                {/* Menggunakan ReactQuill juga, sesuai aturan 'tidak ada komponen lain' */}
                        ...
                        <div className="flex justify-start pt-6 border-t">
                            <ButtonSave type="submit" disabled={isSubmitting}>
                                {/* GANTI: teks */}
                                {isSubmitting ? <><i className="fa fa-spinner fa-spin mr-2"></i> Menyimpan...</> : <><i className="fa fa-save mr-2"></i> Buat Project</>}
                            </ButtonSave>
                        </div>
                    </form>
                </div>
