...
import formatDate from '@/Utilities/formatDateTime'; // Ganti nama import
...
export default function Detail() {
    // GANTI: 'portofolio' menjadi 'buku'
    const { buku, rekapPerKelas, stats, errors, flash } = usePage().props;
    ...
    const handleSubmitGrade = ({ nilai, feedback, submissionId }) => {
        ...
        Inertia.post(route('my.buku.submit_grade', { pengumpulanBuku: submissionId }), {
            nilai,
                        ...
                        <div className="bg-white/70 backdrop-blur-xl rounded-2xl shadow-md p-6 border border-white/20 hover:shadow-xl transition-all duration-300">
                            ...
                            <div className="flex justify-between items-center border-b pb-3">
                                <Link
                                    ...
                                    href={route('my.buku.show', buku.prodi.uuid)}
                            ...
                            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-2 md:gap-4 py-3">
                                ...
                                <span
                                    ...
                                    // GANTI: 'buku' -> 'buku'
                                    title={buku.prodi.nama_prodi}
                                >
                                    prodi {getProdiSingkatan(buku.prodi.nama_prodi)}
                                </span>
                            </div>
