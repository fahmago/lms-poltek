...
// GANTI: Path ke folder KomponenBuku
...
export default function Show() {
    ...
    const { buku, submission, status, flash } = usePage().props;
    ...
    // GANTI: 'buku' -> 'buku'
    const startTime = new Date(buku.waktu_mulai);
    const deadline = new Date(buku.batas_waktu);
    const now = new Date();
        ...
        <MyLayout>
            ...
            <div className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-start">
                    ...
                    {/* === CARD DETAIL TUGAS BUKU === */}
                    <div className="bg-white p-6 rounded-xl shadow-lg h-fit">
                        <div className="flex justify-between items-center mb-4 border-b pb-4">
                            {/* GANTI: 'buku' -> 'buku' */}
                            <h2 className="text-xl font-bold text-gray-800">{buku.judul}</h2>
                        </div>
                                ...
                                return (
                                    <div className="text-center py-8">
                                        ...
                                        <h3 className="text-lg font-semibold text-blue-700">
                                            {/* GANTI: Teks */}
                                            Tugas Buku Belum Dimulai
                                        </h3>
                                        <p className="text-sm text-gray-500 mt-1 mb-6">
                                            {/* GANTI: Teks */}
                                            Anda dapat mulai mengirimkan buku anda dalam:
                                        </p>
                                        {/* GANTI: 'buku' -> 'buku' */}
                                        <Countdown targetDate={buku.waktu_mulai} />
                                    </div>
                                );
                            }
                                ...
                                return (
                                    <div className="text-center py-8">
                                        ...
                                        <p className="text-sm text-gray-500 mt-1">
                                            {/* GANTI: Teks */}
                                            Anda tidak mengumpulkan jawaban untuk tugas buku ini.
                                        </p>
                                    </div>
                                );
                            }
