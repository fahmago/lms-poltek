...
import SubmissionForm from './Atom/SubmissionForm';
import SubmittedView from './Atom/SubmittedView';
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-start">
                    ...
                    <div className="bg-white p-6 rounded-xl shadow-lg h-fit">
                        <div className="flex justify-between items-center mb-4 border-b pb-4">
                            <h2 className="text-xl font-bold text-gray-800">{tugasPekanan.judul}</h2>
                            <span
                                ...
                                return (
                                    <div className="text-center py-8">
                                        ...
                                        <p className="text-sm text-gray-500 mt-1 mb-6">
                                            Anda dapat mulai mengirimkan tugas anda dalam:
                                        </p>
                                ...
                                return (
                                    <div className="text-center py-8">
                                        ...
                                        <p className="text-sm text-gray-500 mt-1">
                                            Anda tidak mengumpulkan jawaban untuk tugas ini.
                                        </p>
                                    </div>
                                );
                            }
