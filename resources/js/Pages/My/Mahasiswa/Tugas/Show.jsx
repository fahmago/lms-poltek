...
const ShowTugas = () => {
    ...
    const onSubmitModal = (formData) => {
        ...
        Inertia.post(route('mhs.tgs.sendTugas'), { ...formData, tugas_id: selectedTugas.id, kode_kelas: kelas.kode_kelas }, {
            onSuccess: () => {
    ...
    const rows = tugas.data.map((tugasItem, index) => {
        ...
        const isSubmitted = tugasItem.pengumpulan_tugas.length > 0;
