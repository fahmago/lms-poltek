...
const ResponTugasHarian = () => {
    ...
    const handleSubmit = (formData) => {
        ...
        Inertia.post(
            route("dsn.dh.tugas.feedBackTugas", { uuid: selectedTugas.uuid }),
            formData,
            {
                onSuccess: () => {
    ...
    const rows = pengumpulanTugas.map((item, index) => [
        ...
        (
            <div className="flex justify-center">
                ...
                <Delete URL={'/my/d/harian/tugas_harian/respon/delete'} id={item.uuid} />
            </div>
        )
    ]);
...
export default ResponTugasHarian;
