...
// GANTI: Path ke komponen Semester
// import RecapStats from '../../Admin/Semester/ProjectSemester/KomponenSemester/RecapStats'; 
...
// Komponen AnswerContent sudah dibuat sebelumnya (pastikan pathnya benar)
...
export default function Detail() {
    ...
    const { projectSemester, kelasHarian, mahasiswaData, stats, errors } = usePage().props;
    ...
    const handleSubmitGrade = ({ nilai, feedback, submissionId }) => {
        ...
        Inertia.put(
            ...
            route('dsn.tsem.submit_grade', { pengumpulanProjectSemester: submissionId }),
                            ...
                            <div className="grid grid-cols-2 gap-4 border-b pb-4">
                                <div className="bg-blue-50 rounded-lg p-3 text-sm">
                                    ...
                                    <p className="text-gray-800 mt-1">
                                         {/* GANTI: 'tugasPekanan' -> 'projectSemester' */}
                                        {formatDateTime(projectSemester.waktu_mulai, { includeTime: true })}
                                    </p>
                                </div>
                                <div className="bg-red-50 rounded-lg p-3 text-sm">
                                    ...
                                    <p className="text-gray-800 mt-1">
                                         {/* GANTI: 'tugasPekanan' -> 'projectSemester' */}
                                        {formatDateTime(projectSemester.batas_waktu, { includeTime: true })}
                                    </p>
                                </div>
                            </div>
