...
import RecapStats from '../../../Admin/Pekanan/TugasPekanan/KomponenPekanan/RecapStats'; // Asumsi path ini benar
...
export default function Detail() {
    ...
    const { buku, kelasHarian, mahasiswaData, stats, errors } = usePage().props;
    ...
    const handleSubmitGrade = ({ nilai, feedback, submissionId }) => {
        ...
        Inertia.put(
            ...
            route('dsn.buku.submit_grade', { pengumpulanBuku: submissionId }),
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-white/70 backdrop-blur-xl rounded-2xl shadow-md p-6 border border-white/20 hover:shadow-xl transition-all duration-300">
                            ...
                            <div className="flex justify-between items-center border-b pb-3">
                                <Link
                                    // GANTI: route
                                    href={route('dsn.buku.show', { kelasHarian: kelasHarian.uuid })}
                            ...
                            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-2 md:gap-4 py-3">
                                {/* GANTI: 'buku' -> 'buku' */}
                                <h1 className="text-2xl font-bold text-gray-900">{buku.judul}</h1>
                                <span
                            ...
                            <div className="grid grid-cols-2 gap-4 border-b pb-4">
                                <div className="bg-blue-50 rounded-lg p-3 text-sm">
                                    ...
                                    <p className="text-gray-800 mt-1">
                                         {/* GANTI: 'buku' -> 'buku' */}
                                        {formatDateTime(buku.waktu_mulai, { includeTime: true })}
                                    </p>
                                </div>
                                <div className="bg-red-50 rounded-lg p-3 text-sm">
                                    ...
                                    <p className="text-gray-800 mt-1">
                                         {/* GANTI: 'buku' -> 'buku' */}
                                        {formatDateTime(buku.batas_waktu, { includeTime: true })}
                                    </p>
                                </div>
                            </div>
                            ...
                            <div
                                ...
                                dangerouslySetInnerHTML={{ __html: buku.deskripsi }}
                            ></div>
                                        ...
                                        <div className="flex items-start sm:items-center gap-4">
                                            ...
                                            <div>
                                                ...
                                                <div className="mt-1">
                                                    ...
                                                    <AnswerContent submission={mhs.submission} buku={buku} nameMhs={mhs.name} />
                                                </div>
