...
export default function Index() {
    ...
    const rows = kelasList.data.map((kelas, index) => [
        ...
        <span className="font-bold text-lg">{kelas.project_semesters_count}</span>,
        (
            <div className="flex justify-center">
                <Link
                    // GANTI: route
                    href={route('dsn.tsem.show', { kelasHarian: kelas.uuid })}
    ...
    return (
        <MyLayout>
            {/* GANTI: Head title */}
            <Head title="Project Semester per Kelas" />
            {/* <div className="mt-5">
                <h1 className="text-2xl font-bold text-gray-800 mb-4">Pilih Kelas untuk Melihat Project Semester</h1>
                <DataTable
                    headers={headers}
                    rows={rows}
            ...
            <div className="mb-8">
                ...
                <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 mb-6 flex flex-col xl:flex-row justify-between items-start xl:items-center gap-6">
                    ...
                    <div className="flex items-center gap-5">
                        {/* Icon Box: fa-laptop-code untuk Project */}
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-500 mt-1">
                                Monitoring progres project semester mahasiswa Anda.
                            </p>
                        </div>
                    </div>
