...
const GradeSubmissionModalInternal = ({ isOpen, onClose, onSubmit, submission, errors, isSubmitting }) => {
    // ... (Komponen ini sama persis seperti di file Buku)
...
export default function Detail() {
    ...
    const { sertifikat, kelasHarian, mahasiswaData, stats, errors } = usePage().props;
    ...
    const handleSubmitGrade = ({ nilai, feedback, submissionId }) => {
        ...
        Inertia.put(
            ...
            route('dsn.sertifikat.submit_grade', { pengumpulanSertifikat: submissionId }),
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-white/70 backdrop-blur-xl rounded-2xl shadow-md p-6 border border-white/20 hover:shadow-xl transition-all duration-300">
                            ...
                            <div className="flex justify-between items-center border-b pb-3">
                                <Link
                                    // GANTI: route
                                    href={route('dsn.sertifikat.show', { kelasHarian: kelasHarian.uuid })}
                            ...
                            <div className="grid grid-cols-2 gap-4 border-b pb-4">
                                <div className="bg-blue-50 rounded-lg p-3 text-sm">
                                    ...
                                    <p className="text-gray-800 mt-1">
                                         {/* GANTI: 'sertifikat' -> 'sertifikat' */}
                                        {formatDateTime(sertifikat.waktu_mulai, { includeTime: true })}
                                    </p>
                                </div>
                                <div className="bg-red-50 rounded-lg p-3 text-sm">
                                    ...
                                    <p className="text-gray-800 mt-1">
                                         {/* GANTI: 'sertifikat' -> 'sertifikat' */}
                                        {formatDateTime(sertifikat.batas_waktu, { includeTime: true })}
                                    </p>
                                </div>
                            </div>
