...
export default function Index() {
    ...
    const rows = kelasList.data.map((kelas, index) => [
        ...
        <span className="font-bold text-lg">{kelas.sertifikats_count}</span>,
        (
            <div className="flex justify-center">
                <Link
                    // GANTI: route
                    href={route('dsn.sertifikat.show', { kelasHarian: kelas.uuid })}
    ...
    return (
        <MyLayout>
            {/* GANTI: Head title */}
            <Head title="Tugas Sertifikat per Kelas" />
            {/* <div className="mt-5">
                <h1 className="text-2xl font-bold text-gray-800 mb-4">Pilih Kelas untuk Melihat Tugas Sertifikat</h1>
                <DataTable
                    headers={headers}
                    rows={rows}
            ...
            <div className="mb-8">
                ...
                <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 mb-6 flex flex-col xl:flex-row justify-between items-start xl:items-center gap-6">
                    ...
                    <div className="flex items-center gap-5">
                        {/* Icon Box: fa-certificate untuk Sertifikat */}
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-500 mt-1">
                                Monitoring pengumpulan sertifikat keahlian mahasiswa Anda.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="w-full xl:w-auto">
                        <div className="w-full md:w-[440px]">
                            <FilterTahunSemester
                                ...
                                filters={filters}
                                url={route('dsn.sertifikat.index')}
                            />
                        </div>
                    </div>
