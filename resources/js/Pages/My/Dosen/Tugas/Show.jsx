...
const ShowTugas = () => {
    ...
    const rows = tugas.data.map((tugasItem, index) => [
        ...
        (
            <div className="flex justify-center">
                <Link href={route('dsn.tugas.responTugas', tugasItem.uuid)}
                ...
                {hasAnyPermission(['dsn.tgs.edit', 'dsn.tgs.delete']) ? (
                    <>
                        {hasAnyPermission(['dsn.tgs.edit']) && (
                            <button
                        ...
                        {hasAnyPermission(['dsn.tgs.delete']) && (
                            <Delete URL={'/my/d/tugas'} id={tugasItem.uuid} />
                        )}
                    </>
                ) : (
    ...
    const handleSubmit = (updatedData) => {
        ...
        Inertia.put(route('dsn.tugas.update', { uuid: selectedTugas.uuid }), updatedData, {
            onSuccess: () => {
