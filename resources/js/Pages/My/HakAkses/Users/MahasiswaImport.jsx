...
const MahasiswaImport = () => {
    ...
    return (
        <>
            <Head>
                <title>eLearning - Import Data Mahasiswa</title>
            </Head>
            <MyLayout>
                <div className="mt-4">
                    <div className="bg-white shadow-sm rounded-md">
                        <div className="bg-green-600 p-4 rounded-t-md">
                            <span className="font-bold text-white tracking-widest">
                                <i className="fa fa-file-excel mr-2"></i> Import Data Mahasiswa
                            </span>
                        </div>
                        <div className="p-6">
                            ...
                            <div className="mb-4 text-sm text-gray-600">
                                ...
                                <ul className="list-disc pl-5">
                                    ...
                                    <li>File Excel harus memiliki kolom-kolom berikut: <strong>Name</strong>, <strong>Email</strong>, <strong>Password</strong>, <strong>Roles</strong>, <strong>Kode Tahun</strong> dan <strong>Kode Prodi</strong>.</li>
                                    <li>Kolom <strong>Roles</strong>, <strong>Kode Tahun</strong> dan <strong>Kode Prodi</strong> harus sesuai dengan data yang terdaftar pada sistem ini.</li>
                                ...
                                <div className="mt-2">
                                    <a
                                        href="/files/sample-users.xlsx"  // Pastikan path ini mengarah ke lokasi file contoh yang benar
                                        className="text-blue-500 hover:text-blue-700 underline"
                                        download
                                    >
                                        Mirror-1 Format Excel Mahasiswa
                                    </a>
                                </div>
                                <div className="mt-2">
                                    <a
                                        href="https://docs.google.com/spreadsheets/d/1xso5gsIMbTaOKEF4ZU44YXi1pdqLdIWy8yw2XWER_Pk/edit?usp=sharing"  // Pastikan path ini mengarah ke lokasi file contoh yang benar
                                        className="text-blue-500 hover:text-blue-700 underline"
                                        target='_blank'
                                    >
                                        Mirror-2 Format Excel Mahasiswa
                                    </a>
                                </div>
                            </div>
...
export default MahasiswaImport;
