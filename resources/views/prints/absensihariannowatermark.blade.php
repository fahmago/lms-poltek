...
<head>
    ...
    overflow: auto;
        ...
        @media print {
            @page {
                size: landscape; /* Mengatur orientasi halaman ke landscape */
            /* margin: 1cm;  Mengatur margin halaman */
            }
            body {
                -webkit-print-color-adjust: exact; /* Memastikan warna dicetak sesuai */
                color-adjust: exact; /* Alternatif untuk browser modern */
            }
        }
        .button {
