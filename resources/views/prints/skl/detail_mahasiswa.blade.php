    ...
    <div class="page-container">
        ...
        <div class="header">
            ...
            <div class="header-text">
                ...
                <p>Politeknik IDN Bogor - Program Studi {{ $mahasiswa->prodi->nama_prodi ?? '-' }}</p>
        ...
        <div class="bio-container">
            ...
            <div style="flex: 1;">
                <table class="bio-table">
                    ...
                    <tr>
                        <td class="bio-label">Telepon / Email</td>
                        <td>:</td>
                        <td class="bio-val">{{ $mahasiswa->telepon ?? '-' }} / {{ $mahasiswa->user->email ?? '-' }}</td>
                    </tr>
                </table>
            </div>
        </div>

        <div class="section-title" style="<?php if (!$avatar['canSeePhoto']) {
                                                echo 'margin-top: 38px;';
                                            } ?>">II. Capaian Ibadah Mahasiswa</div>
        ...
        <div style="margin-bottom: 10px; padding: 0 5px;">
            ...
            *Keterangan: Optimal (100%), Cukup (≥ 80%), Kurang (< 80%)
            ...
            <?php
            $stempel = match ($mahasiswa->prodi->kode_prodi) {
                '58302' => 'stempel_trpl.png',
                '90343' => 'stempel_trmg.png',
                default => 'stempel_trkj.png',
            };
            ?>
        ...
        <script src="/js/charts2/sklChart.js"></script>
        <script src="/js/charts2/attendanceChart.js"></script>
        <script src="/js/charts2/ibadahChart.js"></script>
</body>
